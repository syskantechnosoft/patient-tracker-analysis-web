                ...
                <div class="card" style="box-shadow:0px 20px 50px grey;">
                    ...
                    <div class="card-body">
                        <div style="background:#f0e8f7">
                            ...
                            <form:form action="addClerk"  method="post" style="width: 100%;" modelAttribute="clerk">
                                <form:input path="firstName" type="text" name="fname" placeholder="Enter Clerk's First Name" required="required" />
                                
                                <form:input path="lastName" type="text" name="lname" placeholder="Enter Clerk's Last Name" required="required" />
                                <hr>
                                <form:input path="age" type="number" placeholder="Age" min="1" max="130" name="age" required="required"/>
                                <hr>
                                ...
                                <hr>
                                <form:input path="dateOfBirth" type="date" name="dob" placeholder="Enter Date of Birth" required="required" />
                                <hr>
                                <label for="addressl1"></label> <form:input path="addressLine1" type="textarea" name="addressl1" id=""
                                    placeholder="Address Line 1" required="required" />
                                <hr>
                                <label for="addressl2"></label> <form:input path="addressLine2" type="textarea" name="addressl2"  placeholder="Address Line 2"
                                    required="required" />
                                <hr>
