				...
				<div class="card" style="box-shadow: 0px 20px 50px grey;">
					...
					<div class="card-body">
						<div style="background: #f0e8f7">
							...
							<form:form method="post" style="width: 100%;" modelAttribute="patient">
								<form:input path="firstName" type="text" name="fname"
									placeholder="Enter Patient's First Name" required="required" />
								<hr>
								<form:input path="lastName" type="text" name="lname"
									placeholder="Enter Patient's Last Name" required="required" />
								<hr>
								<form:input path="age" type="number"
									placeholder="Enter Patient's Age" min="1" max="130" name="age"
									required="required" />
								<hr>
								...
								<form:input path="addressLine1" type="textarea" name="addressl1"
									id="" placeholder="Enter Address Line 1" required="required" />
								<hr>
								...
								<form:input path="city" type="text" name="city" id="city"
									placeholder="Enter Patient's City" required="required" />
								<hr>
								<label for="state"></label>
								<form:input path="state" type="text" name="state" id="state"
									placeholder="Enter Patient's State" required="required" />
								<hr>
								<label for="zipcode"></label>
								<form:input path="zipCode" type="text" name="zipcode"
									id="zipcode" placeholder="Enter Patient's Zip Code"
									required="required" />
								<hr>
								<label for="contact"></label>
								<form:input path="contactNumber" type="text"
									name="contactnumber" id="contact"
								...
								<form:input path="emailId" type="email" name="email" id="email"
									placeholder="Enter Patient's Personal EmailID"
									required="required" />
								<hr>
								<div align="right">
